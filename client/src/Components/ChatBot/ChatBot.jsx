  ...
  const steps = [
    {
      id: "0.1",
      message:
        "Hello! My name is Toni-Bot and I will be your guide on this ecommerce!",
      trigger: "0.02",
    },
    {
      id: "0.02",
    ...
    },
    {
      ...
      options: localStorage.getItem("supabase.auth.token")
        ? [
            ...
            {
              value: 4,
              label: "meet the creators of this ecommerce",
              trigger: "4.5",
            },
          ]
        : [
    ...
    },
    {
      id: "2",
      message:
        "Great! we have a lot of hardware, but they can be grouped into different categories.",
      delay: 2,
      trigger: "2.1",
    },
    {
    ...
    },
    {
      id: "4.5",
      message:
        "The about page is under construction, we have 7 dwarves working 12 hours a day. Excuse us.",
      trigger: "999",
    },
    {
      id: "999",
